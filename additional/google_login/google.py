...
app = Flask("Flask Google")
app.secret_key = 'teodortoreador'
...
flow = Flow.from_client_secrets_file(  #Flow is a OAuth 2.0 class that stores all the information on how we want to authorize our users
